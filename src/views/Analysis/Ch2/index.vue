...
<template>
  <div id="ch1">
    ...
    <div class="movie">
      <iframe
        src="//player.bilibili.com/player.html?aid=82537985&bvid=BV18J41157b5&cid=141221520&page=1&high_quality=1&danmaku=0"
        scrolling="no"
        border="0"
        frameborder="no"
        framespacing="0"
    ...
    <div class="link1">
      <router-link to="/analysis/ch1">
        <div class="p3">←1. What are the causes of Australian brushfires?</div>
      </router-link>
    </div>
    <div class="link2">
      <router-link to="/analysis/ch3">
        <div class="p3">3. What are the impacts of the Australia bushfire?→</div>
      </router-link>
    </div>
  </div>
</template>
